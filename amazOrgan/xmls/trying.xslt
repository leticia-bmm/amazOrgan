...
<title>Open Source Free Pet Website Template</title>
  ...
  <div id="main-content">
    <div id="left-column">
      ...
      <div class="box">
        ...
        <p>This Pet Lovers template is an open source template and is released and distributing under Creative Commons 2.5 licence. You are free to use this template in any way you like. All I ask for is that you leave the<span class="crd"><a href="http://www.web-designers-directory.org/" target="_blank"> web site design</a></span> credit links  in the footer of this template intact. Here is how a list looks like: </p>
