...
@Entity
@Table(name = "roles") //to indicate the name of the table
...
public class Role implements Serializable {
	...
	private Integer id;
	private String name;
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "role")  //each role can be assigned to many users (list)
	// by default it is EAGER
	//LAZY: data only retrieved when it is really accessed
